...
\begin{figure}[hbt!]
  \centering
  \framebox(350,200){\textit{Placeholder: Diagrama General de la Solución (Arquitectura del Proyecto)}}
...
\begin{figure}[hbt!]
  \centering
  \framebox(300,150){\textit{Placeholder: Flujograma del proceso ETL e Imputación}}
...
\begin{figure}[hbt!]
  \centering
  \framebox(350,180){\textit{Placeholder: Diagrama del esquema LOPO (Leave-One-Plant-Out)}}
...
La fase final consolida los vectores predictivos generados por cada una de las arquitecturas sometidas a prueba (TFT, Informer, N-HiTS, XGBoost Global/Local, LSTM) contrastándolos unificadamente contra la producción energética empírica de los parques solares aplicando 2 estrategias de testeo diferenciadas según la ventana temporal proyectada (\textit{day1} para predicción a 24 horas y \textit{rollout7d} para proyección expandida iterativa a una semana).
...
\begin{figure}[hbt!]
  \centering
  \framebox(300,200){\textit{Placeholder: Gráficos de barra comparativos y proyecciones temporales de salida}}
  \caption{\label{fig:metrics_visual} Esquema comparativo de métricas de precisión entre arquitecturas locales y globales.}
\end{figure}

\begin{figure}[hbt!]
  \centering
  \framebox(300,200){\textit{Placeholder: Carta Gantt del Proyecto (Capítulo 4)}}
  \caption{\label{fig:gantt_cap4} Cronograma metodológico de actividades para la ejecución de la propuesta.}
\end{figure}
