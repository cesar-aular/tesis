...
% --- ABOUT -----
% Formato proyrcto de título para ICI-UCM
...
\newcommand{\revis}{PROFESOR COMISIÓN}
\newcommand{\reviss}{PROFESOR COMISIÓN}
...
{
  \makeatletter
  \newcommand{\motivo}{Proyecto de título para optar al Título de Ingenirero Civil Informático}
  \ \vspace{-1cm}\\
  {\centering\includegraphics[width=4cm]{logo_ucm}\\}
  \vspace{0.5cm}
  \begin{center}
    {\large
...
\chapter*{Capítulo III\\Estado del Arte / Bechmarking}
